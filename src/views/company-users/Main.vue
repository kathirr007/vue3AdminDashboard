<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Company Users</h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link class="btn btn-primary shadow-md mr-2" :to="`/add-company-user`">Add New Company User</router-link>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ...
    ajaxURL: "https://api.leader.arkanmedia.com/api/companies/users/list/1",
    ajaxConfig:{
      method:"GET",
      headers: {
          "Authorization": 'Bearer 6|wvIWzOGgLVc9yWxKegsm0DVox93El60qlbmVMw2G',
      },
    },
    ajaxFiltering: true,
    ajaxSorting: true,
