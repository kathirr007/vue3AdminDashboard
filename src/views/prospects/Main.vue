...
<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Prospects</h2>
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link class="btn btn-primary shadow-md mr-2" :to="`/add-prospect`">Add New Prospect</router-link>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ...
    ajaxURL: "https://api.leader.arkanmedia.com/api/clients/list/1",
    ajaxConfig:{
      method:"GET",
      headers: {
