<template>
  <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
      <router-link class="btn btn-primary shadow-md mr-2" :to="`/add-user`">Add New User</router-link>
...
const initTabulator = () => {
  tabulator.value = new Tabulator(tableRef.value, {
    ...
    ajaxURL: "https://api.leader.arkanmedia.com/api/users/list",
    ajaxConfig:{
      method:"GET",
      headers: {
...

      {
          ...
          formatter(cell) {
            const a = dom(`<div class="flex lg:justify-center items-center">
                 <a class="flex items-center mr-3" href="/user/edit/${cell.getData().id_user}">
